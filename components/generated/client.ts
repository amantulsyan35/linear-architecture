...
import type {
	TasksGetTaskDataResponse,
	TasksGetTaskDataResponseData,
	UsersGetUsersResponse,
	UsersGetUsersResponseData,
	UsersGetResponse,
	UsersGetInput,
...
export type Queries = {
	"tasks/getTaskData": {
		input?: undefined;
		response: { data?: TasksGetTaskDataResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	"users/getUsers": {
		input?: undefined;
		response: { data?: UsersGetUsersResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	"users/get": {
